...
export default function TermsPage() {
  ...
  const sectionsKo = [
    { title: '제1조 (목적)', content: '이 약관은 QuantaEX Holdings Ltd.(세이셸 공화국 법률에 따라 설립된 국제사업회사, 이하 "회사")가 운영하는 디지털 자산 거래 플랫폼(이하 "서비스")의 이용과 관련하여, 회사와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.' },
    { title: '제2조 (정의)', content: '① "회사"란 QuantaEX Holdings Ltd. (세이셸 공화국 등록 국제사업회사, International Business Company)를 말하며, "QuantaEX"는 회사의 브랜드명입니다.\n② "서비스"란 회사가 제공하는 디지털 자산(암호화폐) 거래, 자산 보관, 정보 제공 등 일체의 서비스를 의미합니다.\n③ "회원"이란 본 약관에 동의하고 회사와 서비스 이용계약을 체결한 자를 말합니다.\n④ "디지털 자산"이란 비트코인(BTC), 이더리움(ETH), QTA 등 블록체인 기술에 기반한 전자적 형태의 자산을 말합니다.\n⑤ "KYC"란 회원의 신원을 확인하기 위한 본인확인(Know Your Customer) 절차를 말합니다.' },
    ...
    { title: '제10조 (준거법 및 분쟁 해결)', content: '① 본 약관 및 서비스 이용에 관한 모든 사항은 세이셸 공화국(Republic of Seychelles)의 법률을 준거법으로 합니다.\n② 서비스 이용으로 발생한 분쟁에 대해 회사와 회원은 상호 협의하여 해결하도록 노력합니다.\n③ 협의가 이루어지지 않을 경우, 본 약관에 관한 모든 분쟁은 세이셸 공화국의 법률에 따라 세이셸 국제중재센터(Seychelles International Arbitration Centre) 또는 세이셸 공화국의 관할 법원에서 최종적으로 해결하며, 회원은 이에 동의합니다.\n④ UN 국제물품매매계약에 관한 협약(CISG)의 적용은 배제됩니다.' },
  ];

  const sectionsEn = [
    { title: 'Article 1 (Purpose)', content: 'These Terms govern the rights, obligations, and responsibilities between QuantaEX Holdings Ltd., an International Business Company incorporated under the laws of the Republic of Seychelles (hereinafter "Company"), and its members regarding the use of the digital asset trading platform (hereinafter "Service").' },
    { title: 'Article 2 (Definitions)', content: '① "Company" refers to QuantaEX Holdings Ltd., an International Business Company (IBC) registered in the Republic of Seychelles. "QuantaEX" is the brand name of the Company.\n② "Service" refers to all services provided by the Company, including digital asset (cryptocurrency) trading, asset custody, and information services.\n③ "Member" refers to a person who agrees to these Terms and enters into a service agreement with the Company.\n④ "Digital Assets" refers to electronic assets based on blockchain technology, including Bitcoin (BTC), Ethereum (ETH), QTA, etc.\n⑤ "KYC" refers to Know Your Customer procedures to verify a member\'s identity.' },
    ...
    { title: 'Article 10 (Governing Law and Dispute Resolution)', content: '① These Terms and all matters relating to the use of the Service shall be governed by and construed in accordance with the laws of the Republic of Seychelles.\n② The Company and members shall first attempt to resolve any disputes arising from the use of the Service through mutual consultation in good faith.\n③ Any dispute that cannot be resolved through consultation shall be finally settled by arbitration administered by the Seychelles International Arbitration Centre under its rules, or by the competent courts of the Republic of Seychelles, and the member hereby consents to such jurisdiction.\n④ The application of the United Nations Convention on Contracts for the International Sale of Goods (CISG) is expressly excluded.' },
  ];
