    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 pb-24">
              ...
              <nav className="space-y-0.5">
                {sections.map((s, i) => (
                  ...
                  >
                    ...
                    <span className="truncate">{s.title.replace(/제\d+조\s*/, '')}</span>
                  </a>
                ))}
              </nav>
            </div>
        ...
        <div className="mt-10 text-center text-xs text-exchange-text-third">
          <p>본 약관에 대한 문의사항은 고객센터(<a href="mailto:support@quantaex.io" className="text-exchange-yellow hover:underline">support@quantaex.io</a>)로 연락해 주시기 바랍니다.</p>
        </div>
      </div>
    </div>
  );
