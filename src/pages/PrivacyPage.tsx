    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-sm text-exchange-text-secondary mt-0.5">최종 수정일: 2026년 4월 20일 | 시행일: 2026년 4월 20일</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="card p-4 lg:sticky lg:top-20">
              <h3 className="text-xs font-semibold text-exchange-text-third uppercase tracking-wider mb-3 px-2">목차</h3>
        ...
        <div className="mt-10 text-center text-xs text-exchange-text-third">
          <p>개인정보 관련 문의: <a href="mailto:privacy@quantaex.io" className="text-exchange-yellow hover:underline">privacy@quantaex.io</a> | 고객센터: <a href="mailto:support@quantaex.io" className="text-exchange-yellow hover:underline">support@quantaex.io</a></p>
        </div>
      </div>
    </div>
  );
