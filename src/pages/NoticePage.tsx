...
const FALLBACK_NOTICES_KO: Notice[] = [
  ...
  {
    id: 3, type: 'event', title: '[이벤트] 회원가입 웰컬 보너스 이벤트', date: '2026-04-20',
