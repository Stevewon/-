...
-- ============================================================================
-- RETIRED ONE-OFF (2026-08): purge of the referral downline under nickname
-- 'sally1992'. This ran ONCE against production and is now COMPLETE — the
-- target rows are gone, so every re-run affected 0 rows. It has been retired
-- (commented out) on 2026-08-27 to keep this migration focused on the real
-- schema changes below (token_version, rate_limits, withdraw_whitelist).
--
-- Kept here (commented) purely as an audit trail of what was executed. DO NOT
-- re-enable: re-running would be a no-op at best and only adds noise/risk.
-- If a similar purge is ever needed again, write a NEW dated migration.
-- ------------------------------------------------------------------------
