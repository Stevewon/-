...
const startMs = Date.parse('2026-09-11T09:20:00+09:00'); // deploy time (KST)
let last = 0.005781;
...
const marks = ['09:20','09:40','10:00','10:30','10:50','12:00','18:00','20:00','22:00','22:59','23:00','23:15','23:30','23:45','23:54','23:55','23:59'];
...
for (let t = startMs; t < kstTimeMs(plan.date, '23:59') + 60_000 + 3 * 3600_000; t += 60_000) {
  ...
  if (t === kstTimeMs('2026-09-12', '02:00')) out['next-day 02:00'] = { phase: s.phase, mid: last };
}
console.table(out);
